...
<head>
    ...
    <title>Detail Transaksi Order</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid m-2">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Detail Histori Transaksi</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row m-2">
                        <a href="{{ route('cetak.struk', $detail->id) }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm m-3"><i
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @foreach ($detail->transaksidetail as $item)
                                <tr>
