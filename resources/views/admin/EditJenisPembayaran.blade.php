            ...
            <div id="content">
                ...
                <div class="container-fluid m-2">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Jenis Pembayarn</h1>
                    </div>
                    ...
                    <!-- Content Row -->
                    <form action="{{route('admin.update.pembayaran', $pembayaran->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                            <div class="m-3">
                                <label for="">Masukan Nama Pembayaran</label>
                                <input type="text" name="nm_pembayaran" value="{{$pembayaran->nm_pembayaran}}" class="form-control ">
                                <label for="">Masukan Nomor</label>
                                <input type="text" name="nomor" value="{{$pembayaran->nomor}}" class="form-control ">
                            </div>
