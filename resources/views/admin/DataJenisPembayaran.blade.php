    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <div class="row m-2">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>{{ $item->nm_pembayaran }}</td>
                                    <td>{{ $item->nomor }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="{{route('admin.edit.pembayaran', $item->id)}}" class="btn btn-primary me-2">Edit</a>
                                            <form action="{{route('admin.delete.jenispembayaran', $item->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE') 
                ...
                {{ $jenisPembayaran->links('pagination::bootstrap-4') }}
                </div>
                <!-- /.container-fluid -->
...
<div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <!-- Header Modal -->
        <div class="modal-header">
          <h5 class="modal-title" id="myModalLabel">Tambah Data Jenis Pembayaran</h5>
        </div>
        <!-- Body Modal -->
       <form action="{{route('admin.create.jenispembayaran')}}" method="POST">
        @csrf
            <div class="m-3">
                <label for="">Masukan Nama Pembayaran</label>
                <input type="text" name="nm_pembayaran" class="form-control ">
                <label for="">Masukan Nomor</label>
