        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid m-2">
                    ...
                    <!-- Content Row -->
                    <form action="{{route('admin.update.datakasir', $kasir->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                            <div class="m-3">
                                <label for="">Masukan Nama Kasir</label>
                                <input type="text" name="name" value="{{$kasir->name}}" class="form-control ">
                                <label for="">Masukan Username</label>
                                <input type="text" name="username" value="{{$kasir->username}}" class="form-control ">
