            ...
            <div id="content">
                ...
                <div class="container-fluid m-2">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Histori Transaksi</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row m-2">
                        <a href="{{route('kasir.create.histori')}}" class="btn btn-primary mb-3">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('kasir.detail.transaksi', $item->id)}}" class="btn btn-primary">Lihat Detail Transaksi</a>
                                    </td>
                                </tr>  
                                @endforeach                         
                            </tbody>
